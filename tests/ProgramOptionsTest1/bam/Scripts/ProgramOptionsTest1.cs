namespace ProgramOptionsTest1
{
        ...
        Bam.Core.IOverrideModuleConfiguration
    {
            ...
            Bam.Core.Environment buildEnvironment)
        {
            if (config is boost.ConfigureSDK boostSDKConfig)
            {
                ...
                boostSDKConfig.IncludedModules.Add(typeof(boost.ProgramOptions));
            }
        ...
        Publisher.Collation
    {
        ...
        Init()
        {
            ...
            this.Include<ProgramOptionsTest1>(C.Cxx.ConsoleApplication.ExecutableKey);
        }
    }
}
